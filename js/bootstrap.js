...
function calcular() {
  ...
  if (nome === "" || peso === "") {
    ...
    resultadoParagrafo.innerHTML = "Por favor, preencha os campos acima!!!"; //imprime a mensagem se nao tiver nada selecionado
    ...
    doseCreatina = Math.round(doseCreatina); // Arredonda para o valor mais próximo

    resultadoParagrafo.innerHTML = "Olá " + nome + ", a dosagem correta para você é " + doseCreatina + " gramas";
...
document.addEventListener("DOMContentLoaded", function() {
  // Esconde o spinner após 2 segundos (2000ms)
  setTimeout(function() {
